...
export const demoSlides: SlideData[] = [
  ...
  },
  {
    ...
    rawText: 'Machine Learning cơ bản\nMachine Learning là gì?\nHọc có giám sát (Supervised Learning)\nHọc không giám sát (Unsupervised Learning)\nHọc tăng cường (Reinforcement Learning)\nCác thuật toán phổ biến: Linear Regression, Decision Tree, SVM, K-Means'
  },
  {
    slideNumber: 5,
...
Bài giảng không chỉ dừng lại ở kỹ thuật mà còn đề cập sâu đến khía cạnh đạo đức trong AI [Slide 8], bao gồm vấn đề thiên kiến, minh bạch, quyền riêng tư và tác động xã hội - những yếu tố không thể thiếu khi phát triển AI có trách nhiệm. Phần kết [Slide 9] mang đến cái nhìn thực tế về cách AI đang thay đổi các ngành y tế, giáo dục, tài chính và giao thông.
...
Tổng thể, bài giảng xây dựng nền tảng vững chắc cho sinh viên muốn khám phá lĩnh vực AI, cân bằng giữa lý thuyết nền tảng và ứng dụng thực tiễn, đồng thời nuôi dưỡng tư duy phê phán và có trách nhiệm khi làm việc với công nghệ AI.`,
  mainTopics: [
    ...
    },
    {
      ...
      summary: 'Machine Learning cho phép máy tính học từ dữ liệu mà không cần lập trình cứng. Ba dạng học chính là có giám sát, không giám sát và tăng cường [Slide 4]. Deep Learning sử dụng mạng nơ-ron nhiều lớp với kiến trúc như CNN (xử lý ảnh), RNN/LSTM (chuỗi thời gian) và Transformer (ngôn ngữ). Quá trình huấn luyện dựa trên Backpropagation và Gradient Descent [Slide 5].',
      sourceSlides: [4, 5]
    },
    {
  ...
  slideSummaries: [
    ...
    },
    {
      ...
      keyPoints: [
        'AI Bias: dữ liệu huấn luyện thiên lệch dẫn đến quyết định không công bằng (ví dụ phân biệt chủng tộc trong nhận dạng khuôn mặt)',
        'Explainability (XAI): yêu cầu AI giải thích được lý do quyết định, đặc biệt trong y tế và tư pháp',
        'EU AI Act và các quy định pháp lý đang định hình trách nhiệm phát triển và triển khai AI'
      ]
    },
    {
      slideNumber: 9,
  ...
  keyTerms: [
    {
      ...
      definition: 'Lĩnh vực khoa học máy tính nghiên cứu và phát triển các hệ thống có khả năng thực hiện các nhiệm vụ đòi hỏi trí thông minh của con người như học hỏi, suy luận, nhận thức và sáng tạo.',
      sourceSlides: [1, 2]
    },
    {
      term: 'Machine Learning (Học máy)',
      definition: 'Nhánh của AI cho phép máy tính học từ dữ liệu và cải thiện hiệu suất theo thời gian mà không cần được lập trình tường minh cho từng nhiệm vụ.',
      sourceSlides: [4]
    },
    {
      term: 'Deep Learning (Học sâu)',
      definition: 'Kỹ thuật Machine Learning sử dụng mạng nơ-ron nhân tạo nhiều lớp để học đặc trưng phân cấp từ dữ liệu, đặc biệt hiệu quả với ảnh, âm thanh và văn bản.',
      sourceSlides: [5]
    },
    {
      term: 'Mạng nơ-ron (Neural Network)',
      definition: 'Mô hình tính toán lấy cảm hứng từ não người, bao gồm các nút (neuron) kết nối với nhau theo lớp, học cách biến đổi đầu vào thành đầu ra thông qua quá trình huấn luyện.',
      sourceSlides: [5]
    },
    {
      term: 'NLP (Xử lý ngôn ngữ tự nhiên)',
      definition: 'Nhánh AI giúp máy tính hiểu, diễn giải và tạo ra ngôn ngữ của con người, bao gồm văn bản và giọng nói. Ứng dụng: dịch máy, chatbot, phân tích cảm xúc.',
      sourceSlides: [6]
    },
    {
      term: 'Transformer',
      definition: 'Kiến trúc mạng nơ-ron sử dụng cơ chế Self-Attention để xử lý chuỗi dữ liệu song song, là nền tảng của các mô hình ngôn ngữ lớn như BERT, GPT và hầu hết AI hiện đại.',
      sourceSlides: [5, 6]
    },
    {
      term: 'Computer Vision (Thị giác máy tính)',
      definition: 'Lĩnh vực AI giúp máy tính phân tích và hiểu nội dung của hình ảnh và video, bao gồm phát hiện vật thể, nhận dạng khuôn mặt và phân đoạn ảnh.',
      sourceSlides: [7]
    },
    {
      term: 'Backpropagation',
      definition: 'Thuật toán huấn luyện mạng nơ-ron bằng cách tính toán gradient của hàm mất mát theo chiều ngược từ đầu ra về đầu vào, sau đó cập nhật trọng số để giảm thiểu sai số.',
      sourceSlides: [5]
    },
    {
      term: 'AI Bias (Thiên kiến AI)',
      definition: 'Hiện tượng hệ thống AI đưa ra kết quả không công bằng hoặc phân biệt đối xử do dữ liệu huấn luyện hoặc thiết kế thuật toán có thiên kiến, ảnh hưởng đến các nhóm người dùng khác nhau.',
      sourceSlides: [8]
    },
    {
      term: 'Large Language Model - LLM (Mô hình ngôn ngữ lớn)',
